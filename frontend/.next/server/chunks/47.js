exports.id=47,exports.ids=[47],exports.modules={805:(e,t,i)=>{"use strict";i.a(e,async(e,r)=>{try{i.d(t,{A:()=>C});var n=i(8732),o=i(2015),s=i(6761),a=i.n(s),l=i(3345),c=i(7495),d=i(4327),h=i(1789),x=i(6229),m=i(3441),p=i(6015),g=i(6585),u=i(6883),A=i(4995),j=i(5597),f=i(3365),y=i(6751),v=i(9623),b=i(3664),w=e([l,c,d,h,x,m,p,y,g,v,u,A,j,f]);[l,c,d,h,x,m,p,y,g,v,u,A,j,f]=w.then?(await w)():w;let C=({open:e,onClose:t,formCalculateData:i={},resetForm:r})=>{let[s,w]=(0,o.useState)({name:"",phone:"",description:"",photo:null}),[C,k]=(0,o.useState)({}),[z,S]=(0,o.useState)(!1),[I,T]=(0,o.useState)({open:!1,message:"",severity:"success"}),[W,R]=(0,o.useState)(null),q=e=>{let{name:t,value:i}=e.target;w(e=>({...e,[t]:i}))},P=()=>{let e={};return s.name||(e.name="Введите имя"),s.phone||(e.phone="Введите телефон"),k(e),0===Object.keys(e).length},D=async e=>{if(e.preventDefault(),P()){S(!0);try{let e=new FormData;e.append("chat_id","-4786257873");let t=`📌 Новая заявка:
