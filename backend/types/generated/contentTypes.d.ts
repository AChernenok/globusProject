...
export interface ApiEmployeeEmployee extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workExperienceAt: Schema.Attribute.Date &
      Schema.Attribute.DefaultTo<'2020-01-01'>;
  };
}
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    menu: Schema.Attribute.Component<'header.menu', true>;
    phone: Schema.Attribute.String;
    phoneCaption: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 20;
      }> &
      Schema.Attribute.DefaultTo<'\u041F\u043E\u0437\u0432\u043E\u043D\u0438\u0442\u0435 \u043D\u0430\u043C'>;
    publishedAt: Schema.Attribute.DateTime;
    schedule: Schema.Attribute.String;
    telegramCaption: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 20;
      }> &
      Schema.Attribute.DefaultTo<'\u041D\u0430\u043F\u0438\u0448\u0438\u0442\u0435 \u043D\u0430\u043C'>;
    telegramLink: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'https://t.me/Office_globus_okna'>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    portfolio_items: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPortfolioItemPortfolioItem
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    minImage: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workDescription: Schema.Attribute.RichText;
  };
}
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText;
    discount: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
